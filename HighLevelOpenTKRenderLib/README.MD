...
- [ ] Predefined objects (:white_circle: cylinder, :white_check_mark: cube, :white_circle: sphere) and :white_circle: ability to setup my own object using vertices/indices/normals 
